    ...
    <div className="pb-16">
      ...
      <div className="relative w-full h-48 md:h-56 flex items-center justify-center">
        <Image
          ...
          alt="Organisation CERAU Header"
          fill
          className="object-cover object-center brightness-75"
          priority
        />
        <div className="relative z-10 text-center">
          <h1 className="text-3xl md:text-5xl font-bold text-white drop-shadow-lg mb-2">Organisation Du CERAU</h1>
          {/* Breadcrumb */}
          <div className="text-sm text-white/90 flex items-center justify-center gap-2">
            <span>Home</span>
            <span className="mx-1">&gt;</span>
            <span className="font-semibold">Organisation Du CERAU</span>
          </div>
        </div>
