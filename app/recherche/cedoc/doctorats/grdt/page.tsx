    ...
    <div className="min-h-screen flex flex-col">
      <main className="flex-grow pt-0">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-black">
          <h2 className="text-3xl font-bold text-center mb-8 text-green-800">Formation doctorale Gestion des Risques et Développement Territorial</h2>

          {/* Objectifs */}
          <section className="mb-8">
            <h3 className="text-2xl font-semibold mb-4 text-green-700">Objectifs</h3>
            <p>
              Cette formation doctorale vise à former des chercheurs et des professionnels capables d'analyser, de comprendre et de gérer les risques liés au développement territorial. Elle s'adresse aux étudiants souhaitant approfondir leurs connaissances dans les domaines de la gestion des risques, de l'aménagement du territoire, de l'urbanisme et du développement durable.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-green-800">
              <li>Gestion des risques naturels et technologiques</li>
              <li>Développement territorial et durabilité</li>
              <li>Politiques publiques et gouvernance des territoires</li>
              <li>Aménagement du territoire et planification urbaine</li>
              <li>Vulnérabilité et résilience des territoires</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-green-800">
              <li>Être titulaire d'un Master ou d'un diplôme reconnu équivalent dans les domaines suivants : Géographie, Urbanisme, Aménagement du territoire, Sciences de l'environnement, Sciences sociales, Sciences économiques, Sciences politiques, Architecture.</li>
